    ...
    <section id="experience" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground">Experience Highlight</h2>
        ...
        <Card className="max-w-4xl mx-auto shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-[1.02]">
          <CardHeader className="bg-secondary p-6">
            <CardTitle className="text-2xl font-semibold text-foreground">Complex Esophageal Surgery: Post-Corrosive Stricture</CardTitle>
            <CardDescription className="text-foreground/80">Case: Demeester Colonic Pull-Up Procedure</CardDescription>
          </CardHeader>
          <CardContent className="p-6 space-y-6">
            <div>
              <h4 className="font-semibold text-lg mb-2 text-foreground">Surgical Challenge</h4>
            ...
            <div>
              <h4 className="font-semibold text-lg mb-3 text-foreground">Anastomoses Performed (Total 5)</h4>
            ...
            <div>
              <h4 className="font-semibold text-lg mb-2 text-foreground">Outcome</h4>
              <p className="text-muted-foreground leading-relaxed">
